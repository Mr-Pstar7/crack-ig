...
```
 ...
 pkg install python
 pkg install git
 git clone https://github.com/Mr-Pstar7/crack-ig
 cd crack-ig
...
```
pkg install python && git clone https://github.com/Mr-Pstar7/crack-ig && cd crack-ig && pip install -r requirements.txt && python ig.py
```
